...
{
    partial class frm_ConsultarReciboDefinitivo
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            dgv_RecibosAtos = new DataGridView();
            reciboProvisorioAtoBindingSource = new BindingSource(components);
            pnl_RecentesReciboProvisorio.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)dgv_Recibos).BeginInit();
            ((System.ComponentModel.ISupportInitialize)dgv_RecibosAtos).BeginInit();
            ...
            pnl_RecentesReciboProvisorio.Controls.Add(dgv_Recibos);
            ...
            pnl_RecentesReciboProvisorio.Controls.Add(dgv_RecibosAtos);
            ...
            // 
            dgv_Recibos.AccessibleRole = AccessibleRole.List;
            dgv_Recibos.AllowUserToAddRows = false;
            dgv_Recibos.AllowUserToDeleteRows = false;
            dgv_Recibos.AllowUserToResizeRows = false;
            dgv_Recibos.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            dgv_Recibos.BackgroundColor = Color.FromArgb(73, 80, 87);
            dgv_Recibos.BorderStyle = BorderStyle.None;
            dgv_Recibos.CellBorderStyle = DataGridViewCellBorderStyle.None;
            dgv_Recibos.ColumnHeadersBorderStyle = DataGridViewHeaderBorderStyle.None;
            ...
            dgv_Recibos.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle1;
            dgv_Recibos.ColumnHeadersHeight = 20;
            ...
            dgv_Recibos.DefaultCellStyle = dataGridViewCellStyle2;
            dgv_Recibos.EditMode = DataGridViewEditMode.EditProgrammatically;
            dgv_Recibos.EnableHeadersVisualStyles = false;
            dgv_Recibos.ImeMode = ImeMode.Off;
            dgv_Recibos.Location = new Point(0, 71);
            dgv_Recibos.MultiSelect = false;
            dgv_Recibos.Name = "dgv_RecibosProvisorios";
            dgv_Recibos.ReadOnly = true;
            dgv_Recibos.RowHeadersBorderStyle = DataGridViewHeaderBorderStyle.None;
            ...
            dgv_Recibos.RowHeadersDefaultCellStyle = dataGridViewCellStyle3;
            dgv_Recibos.RowHeadersVisible = false;
            dgv_Recibos.RowHeadersWidthSizeMode = DataGridViewRowHeadersWidthSizeMode.DisableResizing;
            ...
            dgv_Recibos.RowsDefaultCellStyle = dataGridViewCellStyle4;
            dgv_Recibos.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            dgv_Recibos.Size = new Size(762, 192);
            dgv_Recibos.TabIndex = 7;
            dgv_Recibos.CellClick += dgv_Recibos_CellClick;
            // 
            // btn_Imprimir
            // 
            ...
            // 
            dgv_RecibosAtos.AccessibleRole = AccessibleRole.List;
            dgv_RecibosAtos.AllowUserToAddRows = false;
            dgv_RecibosAtos.AllowUserToDeleteRows = false;
            dgv_RecibosAtos.AllowUserToResizeRows = false;
            dgv_RecibosAtos.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            dgv_RecibosAtos.BackgroundColor = Color.FromArgb(73, 80, 87);
            dgv_RecibosAtos.BorderStyle = BorderStyle.None;
            dgv_RecibosAtos.CellBorderStyle = DataGridViewCellBorderStyle.None;
            dgv_RecibosAtos.ColumnHeadersBorderStyle = DataGridViewHeaderBorderStyle.None;
            ...
            dgv_RecibosAtos.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle5;
            dgv_RecibosAtos.ColumnHeadersHeight = 20;
            ...
            dgv_RecibosAtos.DefaultCellStyle = dataGridViewCellStyle6;
            dgv_RecibosAtos.EditMode = DataGridViewEditMode.EditProgrammatically;
            dgv_RecibosAtos.EnableHeadersVisualStyles = false;
            dgv_RecibosAtos.ImeMode = ImeMode.Off;
            dgv_RecibosAtos.Location = new Point(0, 269);
            dgv_RecibosAtos.MultiSelect = false;
            dgv_RecibosAtos.Name = "dgv_RecibosProvisoriosAtos";
            dgv_RecibosAtos.ReadOnly = true;
            dgv_RecibosAtos.RowHeadersBorderStyle = DataGridViewHeaderBorderStyle.None;
            ...
            dgv_RecibosAtos.RowHeadersDefaultCellStyle = dataGridViewCellStyle7;
            dgv_RecibosAtos.RowHeadersVisible = false;
            dgv_RecibosAtos.RowHeadersWidthSizeMode = DataGridViewRowHeadersWidthSizeMode.DisableResizing;
            ...
            dgv_RecibosAtos.RowsDefaultCellStyle = dataGridViewCellStyle8;
            dgv_RecibosAtos.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            dgv_RecibosAtos.Size = new Size(762, 230);
            dgv_RecibosAtos.TabIndex = 8;
            // 
            ...
            Name = "frm_ConsultarReciboDefinitivo";
            Text = "Consultar Recibo Definitivo";
            Load += frm_ConsultarReciboDefinitivo_Load;
            pnl_RecentesReciboProvisorio.ResumeLayout(false);
            pnl_RecentesReciboProvisorio.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)dgv_Recibos).EndInit();
            ((System.ComponentModel.ISupportInitialize)dgv_RecibosAtos).EndInit();
        ...
        private DataGridView dgv_RecibosAtos;
        private TextBox txtbox_ID;
        private Button btn_Imprimir;
        private Button btn_Buscar;
        private DataGridView dgv_Recibos;
